...
export default async function ActivityPage({
 ...
 <div className="text-[9px] font-bold tracking-widest text-red-400 mb-1.5">Before</div>
 ...
 <div className="text-[9px] font-bold tracking-widest text-emerald-500 mb-1.5">After</div>
 ...
 <div className="mt-3 grid grid-cols-2 gap-3">
 <div className="rounded-lg border border-red-100 bg-red-50/60 p-2.5">
 <div className="text-[9px] font-bold tracking-widest text-red-400 mb-1">Before</div>
 <div className="text-[11px] text-red-800 font-mono">{ce.currentValue || "—"}</div>
 </div>
 <div className="rounded-lg border border-emerald-100 bg-emerald-50/60 p-2.5">
 <div className="text-[9px] font-bold tracking-widest text-emerald-500 mb-1">After</div>
 ...
 <div className="text-[9px] font-bold tracking-widest text-emerald-500 mb-1">Status</div>
