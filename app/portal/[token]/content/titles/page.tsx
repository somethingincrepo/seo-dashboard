...
function QuotaBanner({ quota, packageTier }: { quota: QuotaState; packageTier: PackageTier }) {
 ...
 <div className="text-[11px] font-semibold text-slate-400 tracking-widest mb-2.5">Monthly Content Budget</div>
...
function ProposalCard({
 ...
 <span className="text-[10px] px-1.5 py-0.5 rounded-md bg-violet-100 text-violet-700 font-semibold tracking-wide">Long-Form Guide</span>
 ) : (
 <span className="text-[10px] px-1.5 py-0.5 rounded-md bg-slate-100 text-slate-500 font-semibold tracking-wide">Standard Article</span>
 )}
...
function AddTitlePanel({
 ...
 <div className="text-[10px] font-bold text-indigo-400 tracking-widest mb-2">Generated title</div>
 <textarea
 autoFocus
 value={generated}
 ...
 <div>
 <label className="block text-[11px] font-semibold text-slate-400 tracking-widest mb-1.5">
 Topic or idea
 </label>
 <textarea
 value={idea}
