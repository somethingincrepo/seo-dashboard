...
export function ArticleReviewPanel({ job, result: initialResult, token }: ArticleReviewPanelProps) {
 ...
 <h2 className="text-[11px] font-bold tracking-widest text-slate-400 mb-4">SEO Metadata</h2>
 ...
 <h2 className="text-[11px] font-bold tracking-widest text-slate-400">Article</h2>
 {!isEditing ? (
 <button
