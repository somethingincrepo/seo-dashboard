...
function SectionLabel({ children }: { children: React.ReactNode }) {
 return (
 <div className="text-[11px] font-bold tracking-widest text-slate-400 mb-4">
 {children}
 </div>
 );
}
...
const TOC_SECTIONS = [
 ...
 { id: "page-creation", label: "Page creation" },
...
export default async function GuidePage({
 ...
 <div className="text-[10px] font-bold tracking-widest text-slate-400 mb-3 px-2">
 On this page
 </div>
 {TOC_SECTIONS.map((s) => (
 <a
 ...
 <span className="text-[10px] font-bold tracking-wide text-slate-400 pt-0.5 w-14 shrink-0">{label}</span>
 ...
 <th key={h} className="text-left px-4 py-2.5 text-[11px] font-bold tracking-widest text-slate-400">
 {h}
 </th>
 ))}
 </tr>
