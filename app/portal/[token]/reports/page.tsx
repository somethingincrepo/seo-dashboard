...
function MetricCell({
 ...
 return (
 <div>
 <div className="text-[11px] font-semibold tracking-widest text-slate-400 mb-1">{label}</div>
 {value != null ? (
...
function ReportCard({ report: r }: { report: SupabaseReport }) {
 ...
 <th className="text-left px-3 py-2 text-[11px] font-semibold text-slate-500 tracking-wide">Source</th>
 <th className="text-right px-3 py-2 text-[11px] font-semibold text-slate-500 tracking-wide">This month</th>
 <th className="text-right px-3 py-2 text-[11px] font-semibold text-slate-500 tracking-wide">vs prior</th>
 </tr>
 </thead>
...
export default async function PortalReportsPage({
 ...
 {reports.length > 0 && (
 <div>
 <div className="text-[11px] font-bold tracking-widest text-slate-400 mb-4">Monthly Reports</div>
