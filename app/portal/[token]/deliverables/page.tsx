...
export default async function DeliverablesPage({
 ...
 {/* Header */}
 <div>
 <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-100 border border-slate-200 text-[11px] font-semibold text-slate-500 tracking-widest mb-3">
 {tierLabel} Plan
 </div>
 ...
 <span className={`text-[9px] font-semibold tracking-wide mt-0.5 ${meta.color} opacity-70`}>
 /mo
 </span>
 </div>
