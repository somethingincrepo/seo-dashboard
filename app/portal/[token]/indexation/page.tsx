...
function Tile({ label, value, color = "slate", sub }: { label: string; value: number; color?: "slate" | "green" | "amber" | "red"; sub?: string }) {
 ...
 <div className="text-[11px] font-bold tracking-widest text-slate-400 mb-1">{label}</div>
...
export default function IndexationPage() {
 ...
 <div className="text-[12px] font-bold tracking-widest text-slate-400 mb-3">Submit a URL to Google</div>
 ...
 {/* Column headers */}
 <div className="hidden sm:grid grid-cols-[auto_1fr_80px_120px_130px_32px] gap-3 px-4 py-2 border-b border-slate-100 text-[10px] font-bold tracking-widest text-slate-400">
 <div className="w-4" />
 <div>Page</div>
 <div>Changed</div>
 <div>Submitted</div>
