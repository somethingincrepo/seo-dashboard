...
export function AuditRepeatabilityPanel({ run, priorRuns, currentIssues }: Props) {
 ...
 <div>
 <div className="text-[11px] tracking-widest text-slate-400">Repeatability test</div>
...
function DiffList({ title, items }: { title: string; items: string[] }) {
 ...
 <div className="text-[10px] font-semibold tracking-widest text-slate-500 mb-1">{title}</div>
