...
export function PipelineBoard({ changes, token }: PipelineBoardProps) {
 ...
 {/* What We Recommend */}
 <div>
 <h3 className="text-[11px] font-bold tracking-widest text-slate-400 mb-3">
 What We Recommend
 </h3>
 ...
 {techCurrent && (
 <div>
 <div className="text-[11px] font-bold tracking-widest text-slate-400 mb-2">Current</div>
 ...
 {techProposed && (
 <div>
 <div className="text-[11px] font-bold tracking-widest text-slate-400 mb-2">Proposed</div>
 ...
 {showQuestion && (
 <div className="mt-6">
 <label className="text-[11px] font-bold tracking-widest text-slate-400 mb-2 block">
