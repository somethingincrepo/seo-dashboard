...
function MetadataPanel({
 ...
 <div className="text-[10px] font-bold tracking-widest text-red-400 mb-2">Before</div>
 {before?.title != null && (
 ...
 <div className={`text-[10px] font-bold tracking-widest ${col.label} mb-2`}>After</div>
 {after?.title != null && (
 <div className="mb-1.5">
 <div className="text-[10px] text-slate-400 mb-0.5">Title</div>
...
function RedirectPanel({ before, after, afterStatus }: { before: RedirectValue | null; after: RedirectValue | null; afterStatus: "verified" | "unverified" | "intended" }) {
 ...
 return (
 <div className={`rounded-lg border ${col.border} ${col.bg} p-3`}>
 <div className={`text-[10px] font-bold tracking-widest ${col.label} mb-2`}>Redirect Created</div>
...
function StatusPanel({ label, verifiedValue }: { label: string; verifiedValue?: string }) {
 ...
 <div className={`text-[10px] font-bold tracking-widest mb-1 ${isUnverified ? "text-amber-500" : "text-emerald-500"}`}>
 {label}
 </div>
...
export function BeforeAfterPanel({ change }: BeforeAfterPanelProps) {
 ...
 <h3 className="text-[11px] font-bold tracking-widest text-slate-400">Live Change</h3>
