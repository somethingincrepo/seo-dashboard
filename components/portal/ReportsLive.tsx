...
export function ReportsLive({ token, initialGsc }: ReportsLiveProps) {
 ...
 <div className="text-base font-semibold text-slate-900">Search Console not connected</div>
 <div className="text-xs text-slate-500 mt-1">Your property is saved, but our account doesn&apos;t have access yet — or you may not have GSC set up at all.</div>
 </div>
 ...
 <div>
 <div className="text-[11px] font-bold tracking-widest text-slate-400 mb-0.5">Live Performance</div>
 ...
 {/* Clicks */}
 <div>
 <div className="text-[11px] font-semibold tracking-widest text-slate-400 mb-1">Clicks</div>
 ...
 {/* Impressions */}
 <div>
 <div className="text-[11px] font-semibold tracking-widest text-slate-400 mb-1">Impressions</div>
 ...
 {/* Avg Position */}
 <div>
 <div className="text-[11px] font-semibold tracking-widest text-slate-400 mb-1">Avg Position</div>
 ...
 {/* CTR */}
 <div>
 <div className="text-[11px] font-semibold tracking-widest text-slate-400 mb-1">CTR</div>
 ...
 <div className="text-[10px] font-semibold tracking-widest text-slate-400 mb-3">
 ...
 <th className="text-left px-3 py-2 text-[10px] font-semibold text-slate-500 tracking-wide">Query</th>
 <th className="text-right px-3 py-2 text-[10px] font-semibold text-slate-500 tracking-wide">Clicks</th>
 <th className="text-right px-3 py-2 text-[10px] font-semibold text-slate-500 tracking-wide">Impr.</th>
 <th className="text-right px-3 py-2 text-[10px] font-semibold text-slate-500 tracking-wide">Position</th>
 </tr>
 </thead>
 ...
 <div className="text-[11px] font-bold tracking-widest text-slate-400 mb-0.5">Keyword Intelligence</div>
 ...
 <thead>
 <tr className="bg-slate-50 border-b border-slate-100">
 <th className="text-left px-3 py-2 text-[10px] font-semibold text-slate-500 tracking-wide">Keyword</th>
 <th className="text-right px-3 py-2 text-[10px] font-semibold text-slate-500 tracking-wide">Position</th>
 <th className="text-right px-3 py-2 text-[10px] font-semibold text-slate-500 tracking-wide">Clicks</th>
 <th className="text-right px-3 py-2 text-[10px] font-semibold text-slate-500 tracking-wide">Volume</th>
 <th className="text-right px-3 py-2 text-[10px] font-semibold text-slate-500 tracking-wide">KD</th>
 </tr>
 </thead>
 <tbody className="divide-y divide-slate-50">
