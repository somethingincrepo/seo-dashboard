...
function MetadataPreview({ current, proposed, pageUrl }: { current: string; proposed: string; pageUrl: string }) {
 ...
 <div>
 <div className="text-[11px] font-bold tracking-widest text-slate-400 mb-2">Proposed Direction</div>
 ...
 <div>
 <div className="text-[11px] font-bold tracking-widest text-slate-400 mb-2">Page Title</div>
 ...
 <div>
 <div className="text-[11px] font-bold tracking-widest text-slate-400 mb-2">Meta Description</div>
 <div className="bg-slate-50 rounded-xl px-4 py-2.5 border border-slate-100">
 <div className="text-xs text-slate-400 italic">No changes needed</div>
 </div>
 </div>
...
function MetadataFieldRow({
 ...
 return (
 <div>
 <div className="text-[11px] font-bold tracking-widest text-slate-400 mb-2">{label}</div>
 <div className="space-y-2">
 {/* Current value */}
 <div className="bg-red-50 rounded-xl px-4 py-3 border border-l-2 border-red-100 border-l-red-400">
 <div className="text-[10px] font-semibold tracking-wider text-red-500 mb-1">Current</div>
 {current ? (
 ...
 <div className="text-[10px] font-semibold tracking-wider text-emerald-600 mb-1">Proposed</div>
...
function TechnicalPreview({ current, proposed }: { current: string; proposed: string }) {
 ...
 <div className="text-[11px] font-bold tracking-widest text-slate-400">Current State</div>
 ...
 <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4">
 <div className="flex items-center justify-between mb-2">
 <div className="text-[11px] font-bold tracking-widest text-slate-400">Implementation Code</div>
 ...
 <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4">
 <div className="flex items-center justify-between mb-2">
 <div className="text-[11px] font-bold tracking-widest text-slate-400">Proposed Fix</div>
 <span className="text-xs text-emerald-600">✓</span>
 </div>
...
function ElementPreview({ current, proposed, type }: { current: string; proposed: string; type: string }) {
 ...
 <div>
 <div className="text-[11px] font-bold tracking-widest text-slate-400 mb-2">Current {typeLabel}</div>
 ...
 <div>
 <div className="text-[11px] font-bold tracking-widest text-slate-400 mb-2">
...
function ContentPreview({ current, proposed, type }: { current: string; proposed: string; type: string }) {
 ...
 {current && (
 <div>
 <div className="text-[11px] font-bold tracking-widest text-slate-400 mb-2">Current Content</div>
 <div className="bg-slate-50 border border-slate-200 rounded-xl px-4 py-3">
 ...
 {proposed && (
 <div>
 <div className="text-[11px] font-bold tracking-widest text-slate-400 mb-2">Proposed Content</div>
 <div className="bg-emerald-50 border border-emerald-200 rounded-xl px-4 py-3">
...
function AltTextPreview({ proposed, current }: { proposed: string; current: string }) {
 ...
 <div className="text-[11px] font-bold tracking-widest text-slate-400 mb-2">Alt Text Updates</div>
 {items.map((item, i) => (
...
function InternalLinkV1Preview({ p, index, total }: { p: InternalLinkProposalV1; index: number; total: number }) {
 ...
 <div>
 <div className="text-[11px] font-bold tracking-widest text-slate-400 mb-2">Currently on the page</div>
 <div className="rounded-xl border border-slate-200 bg-slate-50 px-4 py-3">
 <p className="text-sm leading-relaxed text-slate-700" style={{ overflowWrap: "anywhere" }}>{beforeBlock}</p>
 </div>
 </div>
 <div>
 <div className="text-[11px] font-bold tracking-widest text-slate-400 mb-2">After this change</div>
...
function InternalLinkLegacyPreview({ p }: { p: InternalLinkProposalLegacy }) {
 ...
 {context && (
 <div>
 <div className="text-[11px] font-bold tracking-widest text-slate-400 mb-2">Context</div>
 <div className="bg-emerald-50 border border-emerald-200 rounded-xl px-4 py-3">
...
function GeoPreview({ current, proposed }: { current: string; proposed: string }) {
 ...
 <div className="text-[11px] font-bold tracking-widest text-blue-600">AI Search Optimization</div>
 {current && (
