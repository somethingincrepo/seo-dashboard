...
export function ContentActivityFeed({
 ...
 <span className="text-[10px] font-bold tracking-widest text-slate-400">Date</span>
 <span className="text-[10px] font-bold tracking-widest text-slate-400">Title</span>
 <span className="text-[10px] font-bold tracking-widest text-slate-400">Keyword</span>
 <span className="text-[10px] font-bold tracking-widest text-slate-400">Event</span>
 </div>
...
export function ContentKanban({ jobs, results, token, client }: ContentKanbanProps) {
 ...
 const [selectedJob, setSelectedJob] = useState<ContentJob | null>(
   urlJobId ? (jobs.find((j) => j.id === urlJobId) ?? null) : null
 );
 ...
 <div>
 <div className="text-[11px] font-bold tracking-widest text-slate-400 mb-1.5">
